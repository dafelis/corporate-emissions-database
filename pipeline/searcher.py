...
def search_for_emissions_source(
    ...
    return _search_and_rank(
        ...
        ranking_prompt=(
            ...
            "DEPRIORITISE: methodology reports, basis of reporting documents, "
            "verification statements — these describe HOW emissions are calculated, "
            "not the actual emissions values.\n\n"
            "LINK TYPE PRIORITY:\n"
