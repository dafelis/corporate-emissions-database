...
def search_for_emissions_source(
    ...
    return _search_and_rank(
        ...
        ranking_prompt=(
            ...
            "2. Official regulatory filing hosts, which carry the company's own documents: "
            "filings.xbrl.org, data.fca.org.uk (FCA NSM), sec.gov (EDGAR), hkexnews.hk, "
            "asx.com.au, sedarplus.ca, Companies House. Rank these as highly as the "
            "company's own site — they are official copies, not third-party data.\n"
            "3. CDP disclosures, GRI reports hosted on official platforms\n"
            "4. Reputable ESG data providers\n"
            "AVOID: news articles, blog posts, and third-party aggregators that re-type "
            "figures into their own tables (GuruFocus, Macrotrends, etc.)\n"
